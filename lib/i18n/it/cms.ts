export const cmsIt = {
  ...
  lists: {
    ...
    telemetry: {
      subtitle: "Letture qualificate, completamenti e qualità editoriale senza page views legacy.",
      emptyDescription:
        "Gli aggregati qualitativi compariranno qui dopo il primo job osservabilità.",
      periodLabel: "Periodo",
      qualifiedReads: "Letture qualificate",
      completedReads: "Completamenti",
      engagementByDay: "Engagement per giorno",
      topContent: "Contenuti principali",
      topReferrers: "Referrer qualitativi",
