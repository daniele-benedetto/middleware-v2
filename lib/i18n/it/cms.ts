    ...
    resources: {
      ...
      issues: {
        ...
        homeBlocksEditor: {
          ...
          blockTitle: "Blocco",
          diagnostics: "Controlli regia",
          diagnosticsEmptyBlocks: (count: number) =>
            `${count} ${count === 1 ? "blocco vuoto" : "blocchi vuoti"} nella regia.`,
          diagnosticsNoIssues: "Regia completa: nessun articolo scoperto e nessun blocco vuoto.",
          diagnosticsSummary: (used: number, total: number, unused: number) =>
            `${used}/${total} articoli usati · ${unused} non usati`,
          diagnosticsUnusedArticles: (titles: string) => `Articoli non usati: ${titles}.`,
          dropArticlesHint: "Trascina qui gli articoli disponibili o usa le checkbox.",
          duplicateBlock: "Duplica",
          emptyArticles: "Nessun articolo disponibile per questo blocco.",
          featuredArticle: "Articolo featured",
          featuredFallback: "Seleziona articolo",
          generateSuggested: "Genera layout suggerito",
          generateSuggestedConfirmDescription:
            "Il layout suggerito sostituira la regia prima pagina configurata ora.",
          generateSuggestedConfirmTitle: "Sostituire la regia?",
          maxOneArticle: "Max 1 articolo",
          moveDown: "Giu",
          moveUp: "Su",
          noBlocks:
            "Nessun blocco configurato. La home usera il fallback basato sull'ordine articoli.",
          preview: "Preview regia",
          previewEmpty: "Nessun articolo selezionato.",
          previewFeatured: "Featured",
          removeBlock: "Rimuovi",
          selectedArticleOrder: "Ordine articoli selezionati",
          selectedArticles: "Articoli nel blocco",
          source: "Sorgente articoli",
          sourceManual: "Manuale",
          sourceRemainder: "Resto automatico",
          type: "Tipo blocco",
          typeConstellation: "Costellazione",
          typeClosing: "Chiusura",
          typeOpening: "Apertura",
          typeRupture: "Rottura",
          typeSequence: "Sequenza",
        },
        publishingSection: "Pubblicazione e stato",
        slugPreviewPlaceholder: "Slug generato automaticamente",
        slugManualHint: "Clicca sullo slug per modificarlo manualmente",
