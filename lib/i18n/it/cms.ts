export const cmsIt = {
  ...
  forms: {
    ...
    resources: {
      ...
      courses: {
        invalidTitle: "Corso non valido",
        createTitle: "Nuovo Corso",
        editTitle: "Modifica Corso",
        created: "Corso creato.",
        updated: "Corso aggiornato.",
        invalidPublishedAt: "Data pubblicazione non valida.",
        activeLabel: "Corso attivo",
        titleStyledHint:
          "Seleziona una parola o una porzione del titolo, poi clicca Accent o A capo.",
        titleStyledAccentAction: "Accent",
        titleStyledLineBreakAction: "A capo",
        titleStyledEditorAriaLabel: "Editor titolo corso",
        descriptionEditorAriaLabel: "Editor descrizione corso",
        ...
        addLesson: "Nuova lezione",
        slugPreviewPlaceholder: "Slug generato automaticamente",
        slugManualHint: "Clicca sullo slug per modificarlo manualmente",
        selectDatePlaceholder: "Seleziona data",
        createLessonsHint: "Le lezioni si aggiungono dopo il primo salvataggio del corso.",
        untitledPreviewTitle: "Corso senza titolo",
        newPreviewStatus: "Nuovo corso · Non pubblicato",
        previewMetadataTitle: "Anteprima corso",
        newPreviewMetadataTitle: "Anteprima nuovo corso",
      },
      lessons: {
        invalidTitle: "Lezione non valida",
        createTitle: "Nuova Lezione",
        editTitle: "Modifica Lezione",
        created: "Lezione creata.",
        updated: "Lezione aggiornata.",
        contentFieldLabel: "Corpo lezione",
        titleStyledHint:
          "Seleziona una parola o una porzione del titolo, poi clicca Accent o A capo.",
        titleStyledAccentAction: "Accent",
        titleStyledLineBreakAction: "A capo",
        titleStyledEditorAriaLabel: "Editor titolo lezione",
        contentEditorAriaLabel: "Editor contenuto lezione",
        excerptEditorAriaLabel: "Editor excerpt lezione",
        publishingSection: "Pubblicazione e stato",
        courseSection: "Corso",
        courseFieldLabel: "Corso",
        courseLoading: "Caricamento corsi...",
        mediaSection: "Media e distribuzione",
        openImageLibrary: "Libreria immagini",
        openAudioLibrary: "Libreria audio",
        openJsonLibrary: "Libreria JSON",
        ...
        slugManualHint: "Clicca sullo slug per modificarlo manualmente",
        createStatusHint:
          "Le nuove lezioni vengono create in bozza. La pubblicazione si gestisce dopo il primo salvataggio.",
        untitledPreviewTitle: "Lezione senza titolo",
        newPreviewStatus: "Nuova lezione · Non pubblicata",
        previewMetadataTitle: "Anteprima lezione",
        newPreviewMetadataTitle: "Anteprima nuova lezione",
        previewCourseTitle: "Corso di anteprima",
      },
      pages: {
  ...
  quickActions: {
    ...
    confirmDeleteCourseSingle: "Eliminerai definitivamente il corso selezionato.",
    confirmDeleteCourseBulk: (count: number) =>
      `Eliminerai definitivamente ${count} corsi selezionati.`,
    confirmDeleteSingleCourse: "Eliminerai definitivamente questo corso.",
    confirmDeleteSingleLesson: "Eliminerai definitivamente questa lezione.",
    confirmDeleteLessonSingle: "Eliminerai definitivamente la lezione selezionata.",
    confirmDeleteLessonBulk: (count: number) =>
      `Eliminerai definitivamente ${count} lezioni selezionate.`,
  ...
  lists: {
    ...
    courses: {
      ...
      active: "Attivo",
      inactive: "Non attivo",
      reorderUpdated: "Ordine corsi aggiornato con successo.",
      selectItem: (title: string) => `Seleziona ${title}`,
      lessonsPanelTitle: "Lezioni",
      lessonsPanelEmpty: "Nessuna lezione in questo corso.",
      lessonsPanelFeaturedAria: "In evidenza",
      lessonsReorderUpdated: "Ordine lezioni aggiornato con successo.",
    },
    lessons: {
    ...
    auditLogs: {
      ...
      actionFeature: "In evidenza",
      actionUnfeature: "Rimozione evidenza",
      actionReorder: "Riordino",
      actionSyncTags: "Sincronizzazione tag",
      ...
      resourceTagDescription: "Tag editoriale corrente.",
  ...
  preview: {
    ...
    courseResource: "Corso",
    lessonResource: "Lezione",
    ...
    courseStatus: (isActive: boolean, isPublished: boolean) =>
      `${isActive ? "Attivo" : "Non attivo"} · ${isPublished ? "Pubblicato" : "Non pubblicato"}`,
  },
} as const;
