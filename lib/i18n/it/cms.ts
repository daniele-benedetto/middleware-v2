export const cmsIt = {
  ...
  navigationBuilder: {
    ...
    loading: "Caricamento builder navigazione in corso.",
    itemTypes: {
      home: "Home",
      archive: "Archivio uscite",
      formazione: "Contro-formazione",
      page: "Pagina statica",
      article: "Articolo",
      issue: "Uscita",
    ...
    validation: {
      missingLabel: (index: number) => `Voce ${index}: label obbligatoria.`,
      invalidCustomUrl: (index: number) => `Voce ${index}: URL custom non valido.`,
      missingPublishedResource: (index: number) =>
        `Voce ${index}: seleziona una risorsa pubblicata.`,
    },
  },
  resource: {
  ...
  richText: {
    ...
    editImageTitle: "Modifica immagine",
    editImageDescription:
      "Regola il testo alternativo e la visualizzazione dell'immagine nel contenuto.",
    imageAltLabel: "Testo alternativo",
    ...
    zoom: "Ingrandimento",
    resetImageSettings: "Ripristina predefiniti",
    ...
    resources: {
      ...
      articles: {
        ...
        imageSettings: {
          ...
          title: "Visualizzazione copertina",
          description:
            "Le impostazioni vengono applicate in tutte le card e nella pagina dell'articolo.",
          grayscaleLabel: "Bianco e nero",
          grayscaleHint: "Filtro monocromatico",
          fitLabel: "Adattamento",
          fitCover: "Riempi",
          fitContain: "Contieni",
          focalPointLabel: "Punto focale",
          focalPointAriaLabel: (positionX: number, positionY: number) =>
            `Punto focale ${positionX}%, ${positionY}%`,
      ...
      maps: {
        ...
        addressSearchLoading: "Ricerca in corso",
        addressSearchUnavailable: "Ricerca indirizzi non disponibile.",
        closeItemDetail: "Chiudi dettaglio punto",
        activeLabel: "Mappa attiva",
        publishedLabel: "Mappa pubblicata",
        homeVariantLabel: "Variante visiva",
        homeVariantBlack: "Nera",
        homeVariantDefault: "Default",
        homeVariantRed: "Rossa",
        workspaceAttributionHtml:
      ...
      issues: {
        ...
        homeBlocksEditor: {
          ...
          typeRupture: "Rottura",
          typeCourse: "Contro-formazione",
          course: "Contro-formazione",
          coursePlaceholder: "Seleziona contro-formazione",
          typeMap: "Mappa",
          map: "Mappa",
          mapPlaceholder: "Seleziona mappa",
      ...
      questionnaires: {
        invalidTitle: "Questionario non valido",
        createTitle: "Nuovo Questionario",
        editTitle: "Modifica Questionario",
        viewResponses: "Vedi risposte",
        created: "Questionario creato.",
        updated: "Questionario aggiornato.",
        title: "Titolo",
        titleStyledHint:
          "Seleziona una parola o una porzione del titolo, poi clicca Accent o A capo.",
        titleStyledAccentAction: "Accent",
        titleStyledLineBreakAction: "A capo",
        titleStyledEditorAriaLabel: "Editor titolo questionario",
        slugManualHint: "Modifica lo slug o rigeneralo dal titolo",
        slugPreviewPlaceholder: "Slug generato automaticamente",
        description: "Descrizione",
        homeVariantLabel: "Variante visiva home",
        homeVariantBlack: "Nera",
        homeVariantDefault: "Default",
        homeVariantRed: "Rossa",
        definition: "Struttura questionario",
        copy: "Testi pubblici",
        steps: "Step e domande",
        addStep: "Aggiungi step",
        addField: "Aggiungi domanda",
        ...
        fieldTypes: {
          ...
          scale: "Scala numerica",
          consent: "Consenso",
          information: "Informazione",
        },
        fieldLabel: "Domanda",
        fieldDescription: "Descrizione di supporto",
        required: "Risposta obbligatoria",
        publicResults: "Includi nell'analisi pubblica",
        placeholder: "Placeholder",
        minimum: "Minimo",
        maximum: "Massimo",
        stepValue: "Incremento",
        temporalMeaning: "Significato temporale",
        temporalMeaningDistribution: "Distribuzione",
        temporalMeaningEvent: "Evento nel tempo",
        timeDetail: "Dettaglio orario",
        timeDetailNone: "Nessun dettaglio orario",
        timeDetailHourOfDay: "Fascia oraria",
        timeDetailDayHour: "Giorno e ora (sperimentale)",
        minLength: "Lunghezza minima",
        maxLength: "Lunghezza massima",
        minSelections: "Scelte minime",
        maxSelections: "Scelte massime",
        trueLabel: "Etichetta si",
        falseLabel: "Etichetta no",
        minLabel: "Etichetta minimo",
        maxLabel: "Etichetta massimo",
        consentText: "Testo consenso",
        options: "Opzioni",
        ...
        duplicate: "Duplica",
        remove: "Rimuovi",
        locked: "La struttura e bloccata dopo la prima risposta.",
        firstResponseAt: "Prima risposta ricevuta",
        status: "Stato",
        statusDraft: "Bozza",
        ...
        publish: "Pubblica",
        close: "Chiudi questionario",
        archive: "Archivia",
        published: "Questionario pubblicato.",
        closed: "Questionario chiuso.",
        archived: "Questionario archiviato.",
        copyFields: {
          introduction: "Introduzione",
          privacyNotice: "Nota privacy",
          privacyUrl: "URL privacy",
          progressLabel: "Etichetta avanzamento",
          backLabel: "Indietro",
          nextLabel: "Avanti",
          submitLabel: "Invia",
          requiredFieldsMessage: "Messaggio campi obbligatori",
          resumeMessage: "Messaggio ripresa",
          successTitle: "Titolo successo",
          successMessage: "Messaggio successo",
          alreadySubmittedTitle: "Titolo gia inviato",
          alreadySubmittedMessage: "Messaggio gia inviato",
          closedTitle: "Titolo chiusura",
        ...
        sectionsAriaLabel: "Sezioni del questionario",
        overview: "Panoramica",
        copyAndPrivacy: "Testi e privacy",
        settingsTitle: "Impostazioni del questionario",
        untitledStep: "Step senza titolo",
        stepTitle: "Titolo dello step",
        stepDescription: "Descrizione dello step",
        questions: "Domande",
        untitledQuestion: "Domanda senza titolo",
        dragToReorder: "Trascina per riordinare",
        reorderStep: (title: string) => `Riordina ${title}`,
        deleteStep: "Elimina step",
        deleteStepAriaLabel: (title: string) => `Elimina ${title}`,
        reorderQuestion: "Riordina domanda",
        deleteQuestion: "Elimina domanda",
        deleteQuestionAriaLabel: (label: string) => `Elimina ${label}`,
        responseLoading: "Caricamento risposta",
        defaultCopy: {
        ...
        newFieldLabel: "Nuova domanda",
        newOptionLabel: "Opzione",
        booleanTrueLabel: "Si",
        booleanFalseLabel: "No",
        consentDefaultLabel: "Acconsento",
        defaultStepTitle: "Step 1",
        stepTitleFallback: (number: number) => `Step ${number}`,
        stepFallback: (number: number) => `step ${number}`,
        stepProgressLabel: (current: number, total: number) => `Step ${current} di ${total}`,
        csv: {
  ...
  lists: {
    ...
    questionnaires: {
      subtitle: "Gestisci i questionari e le risposte raccolte.",
      table: {
        title: "Titolo",
        slug: "Slug",
        status: "Stato",
      ...
      searchPlaceholder: "Cerca questionari",
      totalRecords: (count: number) => `TOTALE: ${count}`,
      ...
      statusClosed: "Chiusi",
      statusArchived: "Archiviati",
      sortUpdatedAt: "Ordina: aggiornamento",
      sortCreatedAt: "Ordina: creazione",
      sortPublishedAt: "Ordina: pubblicazione",
      sortClosedAt: "Ordina: chiusura",
      sortTitle: "Ordina: titolo",
      sortDescending: "Decrescente",
      sortAscending: "Crescente",
      deleteBulkTitle: "Eliminare i questionari?",
      deleteBulkDescription: (count: number) =>
        `Saranno eliminati ${count} questionari e le relative risposte.`,
      deleteTitle: "Eliminare il questionario?",
      deleteDescription: "L'operazione elimina anche tutte le risposte raccolte.",
      responses: {
        title: "Risposte",
        backToQuestionnaire: "Torna al questionario",
        table: {
        ...
        answerYes: "Si",
        answerNo: "No",
        answerSelected: "Selezionato",
        emptyTitle: "Nessuna risposta ricevuta",
        emptyDescription: "Le risposte inviate compariranno qui.",
        invalidValue: "Valore non leggibile",
      },
    },
    mapItems: {
