...
| Users (ADMIN) | SI                         | NO     | NO   | SI     | SI (delete single/bulk)                                 | NO             |

## Note importanti

- Non tutti i tipi di contenuti hanno tutte le funzionalita: create/edit mancano ancora su tutti i moduli, e su `Users` manca ancora update role in UI.
