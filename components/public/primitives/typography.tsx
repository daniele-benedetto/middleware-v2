...
export const publicTypography = {
  ...
  articleEyebrow:
    "mt-1.5 max-w-[52vw] text-right font-heading text-[11px] font-bold tracking-[0.12em] break-words uppercase md:max-w-[24ch]",
  articleEyebrowWide:
    "mt-1.5 max-w-[52vw] text-right font-heading text-[11px] font-bold tracking-[0.14em] break-words uppercase md:max-w-[24ch]",
  systemCode:
