  ...
  return (
    <div className="bg-background text-foreground md:h-dvh md:max-h-dvh md:overflow-hidden">
      <div className="grid grid-cols-[280px_minmax(0,1fr)] max-md:grid-cols-1 md:h-full">
        <aside className="cms-scroll border-r-2 border-foreground md:sticky md:top-0 md:h-full md:max-h-full md:overflow-y-auto max-md:border-r-0 max-md:border-b-2">
          {sidebar}
        </aside>
